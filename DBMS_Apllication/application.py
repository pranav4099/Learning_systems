...
class dbms_application:
    def __init__(self):
        ...
        self.cursor_obj.execute("PRAGMA foreign_keys = 1;")
    ...
    def decrypt_password(self,enc_password):
        enc_password = bytes(enc_password, "utf-8")
        dec_password = self.security.decrypt(enc_password).decode()
        return dec_password

    def encrypt_password(self,message):
        encMessage = self.security.encrypt(message.encode())
    ...
    def request_login(self):
        while(True):
            self.print_menu()
            main_menu_option = self.accept_input(0,10,"Enter the option: ")
            if(main_menu_option==9):
                break
            ...
            if(main_menu_option==1):
                ...
                if(table_info_retailer[0]==0):
                    ...
                    log_statement = "Retailer "+str(user_id)+" has logged in"
                    self.log_actions(log_statement)
            ...
            if(main_menu_option==2):
                ...
                if(table_info_wholesaler[0]==0):
                    ...
                    if(user_entered_password!=password):
                        ...
                        time.sleep(2)
                        continue
                    log_statement = "Wholesaler "+str(user_id)+" has logged in"
                    self.log_actions(log_statement)
                    self.buyer(user_id, buyer_type)
                ...
                if(table_info[0]==0):
                    ...
                    if(user_entered_password!=password):
                        ...
                        time.sleep(2)
                        continue
                    log_statement = "Port authority "+str(user_id)+" has logged in"
                    self.log_actions(log_statement)
                ...
                if(table_info[0]==0):
                    ...
                    log_statement = "Mover "+str(user_id)+" has logged in"
                    self.log_actions(log_statement)
                ...
                if(table_info[0]==0):
                    ...
                    log_statement = "Manager "+str(user_id)+" has logged in"
                    self.log_actions(log_statement)
            ...
            if(main_menu_option==6):
                ...
                if(table_info[0]==0):
                    ...
                    log_statement = "Seller "+str(user_id)+" has logged in"
                    self.log_actions(log_statement)
                    self.seller(user_id)


            if(main_menu_option==7):
                statement = "select * from insurance_company where company_id="+str(user_id)
                df, table_info=self.get_data(statement,retrun_pd_info=True, show_table=False)
                ...
                if(table_info[0]==0):
                    ...
                    log_statement = "Insurance company "+str(user_id)+" has logged in"
                    self.log_actions(log_statement)
                    self.insurance_company(user_id)


            elif(main_menu_option==8):
                dba_select_statement = "select * from dba"
                df, table_info=self.get_data(dba_select_statement, retrun_pd_info=True, show_table=False)
                if(table_info[0]==0):
                    print("Username does not exist.")
                    time.sleep(2)
                else:
                    ...
                    log_statement = "DBA "+str(user_id)+" has logged in"
                    self.log_actions(log_statement)
                    self.database_admisntrator()
        ...
        while(True):
            ...
            if(main_menu_option==1):
                ...
                while(True):
                    ...
                    self.execute(update_safety_statement)
                    self.execute(warehouse_id_update)
                    self.execute(add_to_warehouse_statement)
    ...
    def seller(self,seller_id):
        while(True):
            ...
            if(main_menu_option==1):
                seller_statement = "select * from manufacturer where seller_id="+str(seller_id)
                df, table_info=self.get_data(seller_statement, retrun_pd_info=True, show_table=False)
                total_orders = df['total_no_of_orders'].values[0]
                ...
                print("Total number of orders recived: ",total_orders)
    ...
    def buyer(self,buyer_id, type_of_buyer):
        purchase_type = "purchase_retailer" if(type_of_buyer=="retailer") else "purchase_wholesaler"
        while(True):
            os.system("clear")
            print("1. View orders")
            print("2. view catalog")
            ...
            if(main_menu_option==1):
                buyer_statement = "select * from "+str(type_of_buyer)+" where buyer_id="+str(buyer_id)
                df, table_info=self.get_data(buyer_statement, retrun_pd_info=True, show_table=False)
                total_orders_placed = df['total_orders_placed'].values[0]
                select_statement = "select * from "+str(purchase_type)+" where buyer_id="+str(buyer_id)
                df, table_info=self.get_data(select_statement, retrun_pd_info=True)
                print("Total orders placed: ",total_orders_placed)
                _ = input("Press any key to exit")
                continue
            ...
            if(main_menu_option==2):
                ...
                while(True):
                    ...
                    if(option==1):
                        ...
                        quantity_upper_limit = 101 if(purchase_type=="purchase_retailer") else 1000000000
                        ...
                        df, table_info=self.get_data(sekect_cargo_for_seller_id, retrun_pd_info=True, show_table=False)
                        if(table_info[0]==0):
                            valid_cargo_id = 1
                        else:
                        ...
                        increment_number_of_purchases_statement = "update "+str(type_of_buyer)+" set total_orders_placed=total_orders_placed + 1 where buyer_id="+str(buyer_id)
                        increment_number_of_orders_statement = "update manufacturer set total_no_of_orders=total_no_of_orders + 1 where seller_id="+str(seller_id)
                        self.execute(make_cargo_statement)
                        self.execute(make_purchase_statement)
                        self.execute(increment_number_of_purchases_statement)
                        self.execute(increment_number_of_orders_statement)
            ...
            if(main_menu_option==3):
                ...
                while(True):
                    ...
                    if(option==1):
                        ...
                        self.execute(insurance_purchase_statement)
                        ...
                        self.execute(delete_insurance_statement)
    ...
    def insurance_company(self, company_id):
        ...
        while(True):
            ...
            if(main_menu_option==1):
                ...
                self.execute(price_update_statement)
                print("Price updated.")
                time.sleep(1)
                continue
            elif(main_menu_option==2):
        ...
        while(True):
            ...
            if(main_menu_option==1):
                ...
                if(assigned_warehouse==None):
                    ...
                    break
                while(True):
                    worker_select_statement = "select cargo_id, seller_id, warehouse_id from holds where warehouse_id="+str(assigned_warehouse)
                    ...
                    if(option==1):
                        ...
                        if(assigned_warehouse==2):
                            update_statement = "delete from holds where cargo_id="+str(cargo_id)+" and seller_id="+str(seller_id)
        ...
        while(True):
            ...
            if(main_menu_option==1):
                while(True):
                    ...
                    if(mover_option==-1):
                        break
                    mover_id = df['worker_id'].values[mover_option]
                    ...
                    update_statement = "update mover set warehouse_id="+str(warehouse_id)+" where worker_id="+str(mover_id)
                    self.execute(update_statement)
    ...
    def database_admisntrator(self):
        while(True):
            os.system('clear')
            print("1. Add/Delete/Update movers")
            print("2. Add/Delete/Update manager")
            print("3. Add/Delete/Update insurance company")
            print("4. Add/Delete/Update sellers")
            print("5. Add/Delete/Update Wholesale buyers")
            print("6. Add/Delete/Update retail buyers")
            print("7. Log out.")

            main_menu_option = self.accept_input(0,8,"Enter the option: ")
            if(main_menu_option==7):
                break
            
            if(main_menu_option==1):
                while(True):
                    select_statement = "select * from mover"
                    df, table_info=self.get_data(select_statement, retrun_pd_info=True)
                    option = self.accept_input(0,5,"Enter 1 to ADD, 2 to UPDATE, 3 to DELETE, 4 to EXIT: ")
                    if(option==4):
                        break
                    elif(option==1):
                        if(table_info[0]==0):
                            ...
                            latest_valid_user_id = int(df['worker_id'].values[table_info[0]-1])
                            valid_user_id = latest_valid_user_id+1
                        
                        password = str(input("Enter the password for the new user:  "))
                        password = self.encrypt_password(password)
                        manager_select_statement = "select worker_id manager from manager"
                        df, table_info=self.get_data(manager_select_statement, retrun_pd_info=True)
                        manager_select_idx = self.accept_input(-1, table_info[0], "Select the Manager IDX: ")
                        manager_id = df['manager'].values[manager_select_idx]
                        add_mover_statement = "insert into mover values("+str(valid_user_id)+",'"+str(password)+"',NULL,"+str(manager_id)+")"
                        self.execute(add_mover_statement)
                        print("User added.")
                        time.sleep(1)
                        ...
                        if(table_info[0]==0):
                            ...
                            continue
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the user to be updated: ")
                        user_id = df['worker_id'].values[idx]
                        new_password = str(input("Enter the new password: "))
                        new_password = self.encrypt_password(new_password)
                        password_update_statement = "update mover set password='"+str(new_password)+"' where worker_id="+str(user_id)
                        print(password_update_statement)
                        self.execute(password_update_statement)
                    ...
                    if(option==3):
                        ...
                        if(table_info[0]==0):
                            print("Please add a user first")
                            continue
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the user to be deleted: ")
                        user_id = df['worker_id'].values[idx]
                        user_delete_statement = "delete from mover where worker_id="+str(user_id)
                        self.execute(user_delete_statement)
                        print("User deleted.")
                        time.sleep(1)
            ...
            if(main_menu_option==2):
                while(True):
                    select_statement = "select * from manager"
                    df, table_info=self.get_data(select_statement, retrun_pd_info=True)
                    option = self.accept_input(0,5,"Enter 1 to ADD, 2 to UPDATE, 3 to DELETE, 4 to EXIT: ")
                    if(option==4):
                        break
                        ...
                        password = str(input("Enter the password for the new manager:  "))
                        password = self.encrypt_password(password)
                        add_manager_statement = "insert into manager values("+str(valid_user_id)+",'"+str(password)+"')"
                        self.execute(add_manager_statement)
                        print("Manager added.")
                        time.sleep(1)
                        ...
                        if(table_info[0]==0):
                            print("Please add a user first")
                            continue
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the manager to be updated: ")
                        user_id = df['worker_id'].values[idx]
                        new_password = str(input("Enter the new password: "))
                        new_password = self.encrypt_password(new_password)
                        password_update_statement = "update manager set password='"+str(new_password)+"' where worker_id="+str(user_id)
                        print(password_update_statement)
                        self.execute(password_update_statement)
                        print("Password updated.")
                        time.sleep(1)
                    ...
                    if(option==3):
                        ...
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the user to be deleted: ")
                        user_id = df['worker_id'].values[idx]
                        user_delete_statement = "delete from manager where worker_id="+str(user_id)
                        self.execute(user_delete_statement)
                        print("User deleted.")
                        time.sleep(1)
            ...
            if(main_menu_option==3):
                while(True):
                    select_statement = "select * from insurance_company"
                    df, table_info=self.get_data(select_statement, retrun_pd_info=True)
                    option = self.accept_input(0,5,"Enter 1 to ADD, 2 to UPDATE, 3 to DELETE, 4 to EXIT: ")
                    if(option==4):
                        break
                        ...
                        if(table_info[0]==0):
                            ...
                            latest_valid_company_id = int(df['company_id'].values[table_info[0]-1])
                            valid_company_id = latest_valid_company_id+1
                        
                        password = str(input("Enter the password for the new insurance company login:  "))
                        password = self.encrypt_password(password)
                        listing_price = self.accept_input(0,1000000,"Enter the listing price for the insurance: ")
                        add_company_statement = "insert into insurance_company values("+str(valid_company_id)+","+str(listing_price)+",'"+str(password)+"')"
                        self.execute(add_company_statement)
                        print("Insurance company added.")
                        time.sleep(1)
                        ...
                        if(table_info[0]==0):
                            print("Please add a user first")
                            continue
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the company to be updated: ")
                        user_id = df['company_id'].values[idx]
                        new_password = str(input("Enter the new password: "))
                        new_password = self.encrypt_password(new_password)
                        password_update_statement = "update insurance_company set password='"+str(new_password)+"' where company_id="+str(user_id)
                        print(password_update_statement)
                        self.execute(password_update_statement)
                        print("Password updated.")
                        time.sleep(1)
                    ...
                    if(option==3):
                        ...
                        if(table_info[0]==0):
                            print("Please add a user first")
                            continue
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the company to be deleted: ")
                        user_id = df['company_id'].values[idx]
                        user_delete_statement = "delete from insurance_company where company_id="+str(user_id)
                        self.execute(user_delete_statement)
            ...
            if(main_menu_option==4):
                while(True):
                    select_statement = "select * from manufacturer"
                    df, table_info=self.get_data(select_statement, retrun_pd_info=True)
                    option = self.accept_input(0,5,"Enter 1 to ADD, 2 to UPDATE, 3 to DELETE, 4 to EXIT: ")
                    if(option==4):
                        break
                        ...
                        if(table_info[0]==0):
                            ...
                            latest_valid_user_id = int(df['seller_id'].values[table_info[0]-1])
                            valid_user_id = latest_valid_user_id+1
                        
                        password = str(input("Enter the password for the new manufacturer:  "))
                        password = self.encrypt_password(password)
                        add_manager_statement = "insert into manufacturer values("+str(valid_user_id)+",'"+str(password)+"',0)"
                        self.execute(add_manager_statement)
                        ...
                        if(table_info[0]==0):
                            print("Please add a user first")
                            continue
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the manufacturer to be updated: ")
                        user_id = df['seller_id'].values[idx]
                        new_password = str(input("Enter the new password: "))
                        new_password = self.encrypt_password(new_password)
                        password_update_statement = "update manufacturer set password='"+str(new_password)+"' where seller_id="+str(user_id)
                        print(password_update_statement)
                        self.execute(password_update_statement)
                        print("Password updated.")
                        time.sleep(1)
                    ...
                    if(option==3):
                        ...
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the user to be deleted: ")
                        user_id = df['seller_id'].values[idx]
                        user_delete_statement = "delete from manufacturer where seller_id="+str(user_id)
                        self.execute(user_delete_statement)
            ...
            if(main_menu_option==5):
                while(True):
                    select_statement = "select * from wholesaler"
                    df, table_info=self.get_data(select_statement, retrun_pd_info=True)
                    option = self.accept_input(0,5,"Enter 1 to ADD, 2 to UPDATE, 3 to DELETE, 4 to EXIT: ")
                    if(option==4):
                        break
                        ...
                        if(table_info[0]==0):
                            ...
                            latest_valid_user_id = int(df['buyer_id'].values[table_info[0]-1])
                            valid_user_id = latest_valid_user_id+1
                        
                        password = str(input("Enter the password for the new wholesale user:  "))
                        password = self.encrypt_password(password)
                        add_manager_statement = "insert into wholesaler values("+str(valid_user_id)+",'"+str(password)+"',0)"
                        self.execute(add_manager_statement)
                        print("wholesaler added.")
                        time.sleep(1)
                        ...
                        if(table_info[0]==0):
                            print("Please add a user first")
                            continue
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the wholesaler to be updated: ")
                        user_id = df['buyer_id'].values[idx]
                        new_password = str(input("Enter the new password: "))
                        new_password = self.encrypt_password(new_password)
                        password_update_statement = "update wholesaler set password='"+str(new_password)+"' where buyer_id="+str(user_id)
                        print(password_update_statement)
                        self.execute(password_update_statement)
                        print("Password updated.")
                        time.sleep(1)
                    ...
                    if(option==3):
                        ...
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the user to be deleted: ")
                        user_id = df['buyer_id'].values[idx]
                        user_delete_statement = "delete from wholesaler where buyer_id="+str(user_id)
                        self.execute(user_delete_statement)
                        print("User deleted.")
                        time.sleep(1)
            ...
            if(main_menu_option==6):
                while(True):
                    select_statement = "select * from retailer"
                    df, table_info=self.get_data(select_statement, retrun_pd_info=True)
                    option = self.accept_input(0,5,"Enter 1 to ADD, 2 to UPDATE, 3 to DELETE, 4 to EXIT: ")
                    if(option==4):
                        break
                        ...
                        password = str(input("Enter the password for the new wholesale user:  "))
                        password = self.encrypt_password(password)
                        add_manager_statement = "insert into retailer values("+str(valid_user_id)+",'"+str(password)+"',0)"
                        self.execute(add_manager_statement)
                        ...
                        if(table_info[0]==0):
                            print("Please add a user first")
                            continue
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the retailer to be updated: ")
                        user_id = df['buyer_id'].values[idx]
                        new_password = str(input("Enter the new password: "))
                        new_password = self.encrypt_password(new_password)
                        password_update_statement = "update retailer set password='"+str(new_password)+"' where buyer_id="+str(user_id)
                        print(password_update_statement)
                        self.execute(password_update_statement)
                        print("Password updated.")
                        time.sleep(1)
                    ...
                    if(option==3):
                        ...
                        idx = self.accept_input(-1,table_info[0],"Enter the IDX of the user to be deleted: ")
                        user_id = df['buyer_id'].values[idx]
                        user_delete_statement = "delete from retailer where buyer_id="+str(user_id)
                        self.execute(user_delete_statement)
                        print("User deleted.")
                        time.sleep(1)
