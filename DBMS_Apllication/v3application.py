            ...
            if(main_menu_option==1):
                while(True):
                    ...
                    if(option==4):
                        ...
                        self.cursor_obj.execute(add_mover_statement)
                        print("User added.")
                        time.sleep(1)
                        ...
                        self.cursor_obj.execute(password_update_statement)
                    ...
                    if(option==3):
                        ...
                        self.cursor_obj.execute(user_delete_statement)
                        print("User deleted.")
                        time.sleep(1)
            ...
            if(main_menu_option==2):
                while(True):
                    ...
                    if(option==4):
                        ...
                        self.cursor_obj.execute(add_manager_statement)
                        print("Manager added.")
                        time.sleep(1)
            ...
            if(main_menu_option==3):
                while(True):
                    ...
                    if(option==4):
                        ...
                        self.cursor_obj.execute(add_company_statement)
            ...
            if(main_menu_option==4):
                while(True):
                    ...
                    if(option==4):
                        ...
                        add_manager_statement = "insert into manufacturer values("+str(valid_user_id)+",'"+str(password)+"')"
                        self.cursor_obj.execute(add_manager_statement)
            ...
            if(main_menu_option==5):
                while(True):
                    ...
                    if(option==4):
                        ...
                        add_manager_statement = "insert into wholesaler values("+str(valid_user_id)+",'"+str(password)+"',NULL)"
                        self.cursor_obj.execute(add_manager_statement)
            ...
            if(main_menu_option==6):
                while(True):
                    ...
                    if(option==4):
                        ...
                        password = str(input("Enter the password for the new wholesale user:  "))
                        add_manager_statement = "insert into retailer values("+str(valid_user_id)+",'"+str(password)+"',NULL)"
                        self.cursor_obj.execute(add_manager_statement)
